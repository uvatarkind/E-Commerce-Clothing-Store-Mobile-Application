...
AppBar buildAppBar(BuildContext context) {
  ...
  // Removed duplicate and misplaced AppBar block
...
padding: const EdgeInsets.all(16),
              children: [
                _buildCartItem('Watch', 'Rolex', '\$40', '2', 'lib/assets/watch.png'),
                const Divider(),
                _buildCartItem('Airpod', 'Apple', '\$333', '2', 'lib/assets/airpods.png'),
                const Divider(),
                _buildCartItem('Hoodie', 'Puma', '\$50', '2', 'lib/assets/hoodie.png'),
              ],
            ),
          ),
          Container(
  ...
  Widget _buildCartItem(String name, String brand, String price, String quantity, String imagePath) {
    return Row(
      children: [
        ClipRRect(
